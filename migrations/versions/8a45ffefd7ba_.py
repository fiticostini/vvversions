...
Revision ID: 8a45ffefd7ba
Revises: 
Create Date: 2023-04-27 18:17:58.739653
...
def upgrade():
    ...
    sa.Column('banda', sa.Enum('solista', 'mezclador', 'ing_sonido', name='banda'), nullable=False),
